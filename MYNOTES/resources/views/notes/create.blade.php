...
<body>
    ...
    <body>
        <div class="d-flex justify-content-end mb-4">
            ...
            <form action="{{route('mynote.store')}}" method="post" enctype="multipart/form-data" class="shadow p-4 rounded bg-light">
                @csrf
                <div class="row mt-2">
                    ...
                    <div class="form-group mt-2 animate__animated animate__fadeInUp">
                        ...
                        <textarea name="note_content" class="form-control" rows="3" placeholder="note_content"></textarea>
                    </div>
